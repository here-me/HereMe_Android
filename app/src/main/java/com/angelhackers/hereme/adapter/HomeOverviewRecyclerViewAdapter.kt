...
class HomeOverviewRecyclerViewAdapter(val ctx: Context,var dataList: ArrayList<HomeOverviewData>):RecyclerView.Adapter<HomeOverviewRecyclerViewAdapter.Holder>(){
